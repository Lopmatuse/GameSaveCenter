...
更新时间：2026-08-05
当前版本：`0.6.39-development-preview`

> 0.6.39 在 0.6.38 的大型库启动保护上继续收口 UI：Settings 与侧栏共享页面滚动；低高度不删除摘要；表格有限视口提高但保留页面级溢出与 DataGrid 虚拟化。当前真实 Playnite、主题、DPI 和 900+ 游戏库仍待用户侧验证。

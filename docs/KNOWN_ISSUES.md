...
更新时间：2026-08-05
目标版本：`0.6.52-development-preview`

0.6.52 新增：修改器卡片使用可读自动启动状态；0.6.51 新增 Worker 初始化日志写入程序集版本，便于确认旧版扩展目录/Worker 没有被 Playnite 继续复用。用户提供的日志明确显示 `GameSaveCenter 0.6.22`，不能用于判断 0.6.50/0.6.51/0.6.52 的大型库行为。
